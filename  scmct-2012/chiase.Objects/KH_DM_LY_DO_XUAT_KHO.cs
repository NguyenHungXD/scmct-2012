...
//───────────────────────────────────────────────────────────────────────────────────────
 namespace chiase.Objects
  { 
 public class KH_DM_LY_DO_XUAT_KHO:  SQLConnectWeb { 
 public static string sTableName= "KH_DM_LY_DO_XUAT_KHO"; 
   public string ID;
   public string NAME;
...
//───────────────────────────────────────────────────────────────────────────────────────
 public static KH_DM_LY_DO_XUAT_KHO Insert_Object(
string  sNAME
            ,string  sVISIBLE_BIT
            ) 
 { 
             ...
             string sqlSave=" INSERT INTO KH_DM_LY_DO_XUAT_KHO("+
                   "NAME," 
        +                   "VISIBLE_BIT) VALUES("
 +tem_sNAME+","
 +tem_sVISIBLE_BIT +")";
          ...
          KH_DM_LY_DO_XUAT_KHO newKH_DM_LY_DO_XUAT_KHO= new KH_DM_LY_DO_XUAT_KHO();
                 newKH_DM_LY_DO_XUAT_KHO.ID=GetTable( " SELECT TOP 1 ID FROM KH_DM_LY_DO_XUAT_KHO ORDER BY ID DESC ").Rows[0][0].ToString();
              newKH_DM_LY_DO_XUAT_KHO.NAME=sNAME;
              newKH_DM_LY_DO_XUAT_KHO.VISIBLE_BIT=sVISIBLE_BIT;
            return newKH_DM_LY_DO_XUAT_KHO; 
           } 
           else return null ;
}
//───────────────────────────────────────────────────────────────────────────────────────
...
public static DataTable GetTableFields(string sWhere, string[] orderFields, params string[] fields)
{
 ...
 string sqlSelect = string.Format(" SELECT {0} FROM {1} ", field, "KH_DM_LY_DO_XUAT_KHO");
 if (!string.IsNullOrEmpty(sWhere))
    sqlSelect += " where " + sWhere;
 string order = "";
 if (orderFields != null && orderFields.Length > 0)
...
//───────────────────────────────────────────────────────────────────────────────────────
   ...
   public static bool Change_dt_KH_DM_LY_DO_XUAT_KHO = true;
   public static bool AllowAutoChange = true;
   public static DataTable get_KH_DM_LY_DO_XUAT_KHO()
   {
