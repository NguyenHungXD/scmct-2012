...
//───────────────────────────────────────────────────────────────────────────────────────
    ...
    DataTable dt=SearchByPCK_CT_ID(sPCK_CT_ID) ;
    if(dt!=null && dt.Rows.Count>0) 
      return new KH_PHIEU_CHUYEN_KHO_CT(dt,0);
      return null;
}
//───────────────────────────────────────────────────────────────────────────────────────
...
//───────────────────────────────────────────────────────────────────────────────────────
 public KH_PHIEU_CHUYEN_KHO_CT( DataTable table,int pos)
{
         this.PCK_CT_ID= table.Rows[pos]["PCK_CT_ID"].ToString();
...
//───────────────────────────────────────────────────────────────────────────────────────
 public static DataTable SearchByPCK_CT_ID(string sPCK_CT_ID)
{
...
//───────────────────────────────────────────────────────────────────────────────────────
 public static DataTable SearchByPCK_CT_ID(string sPCK_CT_ID,string sMatch)
{
 ...
 public static DataTable SearchByPNK_CT_ID(string sPNK_CT_ID,string sMatch)
{
 ...
 public static DataTable Search( string sPCK_CT_ID
            , string sPCK_ID
            , string sHH_ID
            , string sSO_LUONG
            , string sDON_GIA
...
public static DataTable GetTableFields(string sWhere, string[] orderFields, params string[] fields)
{
 ...
 string sqlSelect = string.Format(" SELECT {0} FROM {1} ", field, "KH_PHIEU_CHUYEN_KHO_CT");
 if (!string.IsNullOrEmpty(sWhere))
    sqlSelect += " where " + sWhere;
 string order = "";
 if (orderFields != null && orderFields.Length > 0)
...
//───────────────────────────────────────────────────────────────────────────────────────
   ...
   if (dt_KH_PHIEU_CHUYEN_KHO_CT == null || Change_dt_KH_PHIEU_CHUYEN_KHO_CT == true)
     {
   dt_KH_PHIEU_CHUYEN_KHO_CT = GetTableAll();
