...
namespace chiase.Objects
{
    public class DM_HANG_HOA : SQLConnectWeb
    {
        ...
        public static DataTable dtSearchByMA_HH(string sMA_HH)
        {
        ...
        public static DataTable dtSearchByNHH_ID(string sNHH_ID)
        {
        ...
        //───────────────────────────────────────────────────────────────────────────────────────
        public static DataTable dtSearchByNHH_ID(string sNHH_ID, string sMatch)
        {
            string sqlSelect = s_Select() + " WHERE NHH_ID" + sMatch + sNHH_ID + "";
            DataTable dt = GetTable(sqlSelect);
            return dt;
        }//───────────────────────────────────────────────────────────────────────────────────────
        public static DataTable dtSearchByMO_TA(string sMO_TA)
        {
