<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="search_status_request.aspx.cs" Inherits="chiase.search_status_request" %>
...
<fieldset >
    <script type="text/javascript">
        ...
        function update_request(id) {
            var contentUrl = "create_new_status_request.aspx?id=" + id;
            var windowIndex = 1;
                ...
                if (obj.chk.length > 0) {
                    for (i = 0; i < obj.chk.length; i++) {
                        if (obj.chk[i].checked == true) {
                            var url = "search_status_request.aspx?id=" + obj.chk[i].value + "&vmode=" + vmode;
                            loadXMLUpdate(url);
                            checked = true;
                        }
                    }
                    ...
                    if (obj.chk.checked == true) {
                        var url = "search_status_request.aspx?id=" + obj.chk.value + "&vmode=" + vmode;
                        loadXMLUpdate(url);
                        checked = true;
                    }
                }
...
<fieldset>
    ...
    <table border="0" cellpadding=3 cellspacing=1 width="100%"  style="border:1px solid #CCFFFF;color:Black">
        <tr bgcolor="#1A15FB" style="color:White;font-weight:bold"><td align="center" colspan="6">DANH SÁCH TRẠNG THÁI YÊU CẦU</td></tr>
