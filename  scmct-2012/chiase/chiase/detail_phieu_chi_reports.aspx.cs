...
namespace chiase
{
    public partial class detail_phieu_chi_reports : System.Web.UI.Page
    {
        ...
        public void display()
        {
            try
            {
                string sql = @"exec sp_TC_CHI_TIET_CHI_BY_DA ";
                ...
                phieu_chi_report_detail.DataSource = table;
                phieu_chi_report_detail.DataBind();
