<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="detail_transfer_to_reports.aspx.cs" Inherits="chiase.detail_transfer_to_reports" %>
...
<div id="mydiv">
  <table border="0" cellpadding=2 cellspacing=1 width="100%"  style="border:1px solid #CCFFFF;color:Black">
        <tr bgcolor="#1A15FB" style="color:White;font-weight:bold"><td align="center" colspan="11">BÁO CÁO CHI TIẾT CHUYỂN DI</td></tr>
<asp:Repeater ID="transfer_to_report_detail" runat="server">
    <HeaderTemplate>
