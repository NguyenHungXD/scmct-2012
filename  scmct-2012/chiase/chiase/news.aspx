<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="news.aspx.cs" Inherits="chiase.news" %>
...
<script type="text/javascript">
        function update_request(id) {
            var contentUrl = "create_new_subject.aspx?id=" + id + "&types_id=2";
            var windowIndex = 1;
...
<fieldset>
   ...
   <td with=60%>
<img src="images/item.png" width=18 height=18> TIN TỨC SCMCT ONLINE
   </td>
      <td align=left>
        <table cellpadding=0 cellspacing=0 border=0 width=100%> <tr><td align=center>Bài mới</td><td align=right><asp:Label ID="lbl_create_new_subject" runat="server" ><a id="create_new_subject" class="btn" href='#' title='Chuyên mục mới' >  <img src="images/post_new.png" width="20" height="20"> Chuyên mục mới</a></asp:Label>
         ...
         <dx:ASPxPopupControl ID="ASPxPopupControl3" runat="server" 
                    AllowDragging="True" AllowResize="True"
                            CloseAction="CloseButton" ContentUrl="create_new_subject.aspx?types_id=2"
   ...
   <asp:Repeater ID="showListNews" runat="server" 
        ...
        <img src="images/newsinfo.png" width=15 height=15> <b><%#Eval("title") %></b>
        </a>
        <td>
        <td align =right>
...
<%--        <tr>
   ...
   <asp:Repeater ID="showListNewsDetail" onitemdatabound="showListNewsDetail_ItemDataBound"  runat="server" >
        ...
        <td>
            ...
            <tr>
            <td>
            <img src="images/item.png" width=15 height=15> <b><%#Eval("title") %></b>
            </td>
            <td align="right">
