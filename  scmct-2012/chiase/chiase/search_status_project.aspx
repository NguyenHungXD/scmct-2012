...
<fieldset>
    ...
    <asp:Repeater ID="status_list" runat="server"  onitemdatabound="status_list_ItemDataBound" >
    <HeaderTemplate>
    ...
    <ItemTemplate>
        <tr bgcolor='#<%# Eval("bgcolors")%>' align="center">
            ...
            <%=vNo++ %>. 
            <input name="chk" value="<%#Eval("id") %>" type="checkbox" /> <asp:Label ID="lbl_edit" runat="server"> | 
                    <a style=cursor:pointer title='Sửa yêu cầu' onclick=update_request('<%#Eval("id") %>')><img src=images/edit.gif width=20 height=20 alt='Cập nhật chủ đề'></a></asp:Label>
        </td>
        <td align="left">
            <%# Eval("name")%>
        </td>
    ...
    <FooterTemplate>
       ...
       <tr>
    <td colspan="4" style="color:white;font-weight:bold"><br>
        ...
        *-Chọn trạng thái bạn muốn xóa/phục hồi.<br><br>
        ...
        <asp:Label ID="lbl_del_status" runat="server" >
