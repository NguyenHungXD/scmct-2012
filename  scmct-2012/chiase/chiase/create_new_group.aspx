<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="create_new_group.aspx.cs" Inherits="chiase.create_new_group" %>
...
<body>
    ...
    <td align="center"><br><hr>
        ...
        <td valign="middle" align="right">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" ControlToValidate="txt_name" ForeColor="red" runat="server" ErrorMessage="Nhập tên nhóm mới"></asp:RequiredFieldValidator><br>
            Tên trạng thái:<asp:TextBox ID="txt_name" runat="server" class="txtformat" Width="200px" Height="25px"></asp:TextBox>
        ...
        <td valign="middle" align="right">
            ...
            <asp:Button ID="btn_saves" runat="server" Text="Lưu thông tin" class="btn" 
